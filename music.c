...
const Pattern_frame pattern[][pattern_size] = {
    {
        {0x10 | note_f  , 0xD7, 0x20 | note_d   , 0xF2, 0xC4},
        {0x00           , 0x07, 0x00            , 0x02, 0xC3},
        {0x20 | note_f  , 0xD7, 0x20 | note_d   , 0xF2, 0xC4},
        {0x00           , 0x07, 0x00            , 0x02, 0xC3},
        {0x30 | note_c  , 0xD7, 0x20 | note_a   , 0xF2, 0xC3},
        {0xFF           , 0xDF, 0xFF            , 0xFF, 0xC3},
        {0xFF           , 0xDF, 0xFF            , 0xFF, 0xC5}
    },
    {
        {0x30 | note_g  , 0xD7, 0x20 | note_d   , 0xF2, 0xC4},
        {0x00           , 0x07, 0x00            , 0x02, 0xC3},
        {0x20 | note_f  , 0xD7, 0x20 | note_d   , 0xF2, 0xC4},
        {0x00           , 0x07, 0x00            , 0x02, 0xC3},
        {0x20 | note_a  , 0xD6, 0x20 | note_dis , 0xF2, 0xC4},
        {0x30 | note_c  , 0xD6, 0xFF            , 0xFF, 0xC3},
        {0x30 | note_d  , 0xD6, 0xFF            , 0xFF, 0xC5}
    },
    {
        {0x20 | note_f  , 0xD7, 0x20 | note_d   , 0xF2, 0xC4},
        {0x00           , 0x07, 0x00            , 0x02, 0xC3},
        {0x20 | note_f  , 0xD7, 0x20 | note_d   , 0xF2, 0xC4},
        {0x00           , 0x07, 0x00            , 0x02, 0xC3},
        {0x30 | note_d  , 0xD7, 0x20 | note_a   , 0xF2, 0xC5},
        {0xFF           , 0xDF, 0xFF            , 0xFF, 0xC3},
        {0xFF           , 0xDF, 0xFF            , 0xFF, 0xC5}
    }};
